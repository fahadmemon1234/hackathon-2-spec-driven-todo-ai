# Data Model: TaskCard Priority & Category Visual Display
...
### Attributes
- **id**: `string` - Unique identifier assigned when task is created
...
- A task can transition from incomplete to complete state and vice versa
